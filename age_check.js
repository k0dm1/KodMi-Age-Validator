...
constructor(call_back,age_limit,thecode,thecss,sorrycode){
	...
	this.thecss = "<style>.age_verify_inner_kodmi{width:100%;max-width:500px;padding:0 15px;display:block;text-align:Center}.age_verify_kodmi{position:absolute;top:0;left:0;width:100%;height:100%;background-color:#fff;display:grid;place-items:center center}.age_verify_kodmi p{color:#000;display:block;z-index:999;font-size:2em;margin:10px 0 0}.top-kodmi-text{margin-top:0!important}.age_verify_kodmi span{font-size:1em;display:block;color:#ccc;margin-top:0}.age_verify_kodmi span a{color:green}.slidecontainer_kodmi{width:100%;margin-top:25px}.slider_kodmi{-webkit-appearance:none;appearance:none;width:100%;height:25px;background:#d3d3d3;outline:0;opacity:.7;-webkit-transition:.2s;transition:opacity .2s}.slider_kodmi:hover{opacity:1}.slider_kodmi::-webkit-slider-thumb{-webkit-appearance:none;appearance:none;width:50px;height:50px;background:#4CAF50;cursor:pointer}.slider_kodmi::-moz-range-thumb{width:50px;height:50px;background:#4CAF50;cursor:pointer}#age_numb_kodmi{font-size:3em;margin-bottom:10px}#kodmi-button{background-color:#4CAF50;border:none;color:#fff;padding:16px 32px;text-align:center;text-decoration:none;display:inline-block;font-size:16px;margin:50px 2px 4px;-webkit-transition-duration:.4s;transition-duration:.4s;cursor:pointer}</style>";
	}
	if(sorrycode){
